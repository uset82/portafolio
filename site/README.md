...
| `OPENROUTER_MODEL`                      | Server only               | Optional in prototype mode         | Overrides the `openrouter/free` prototype default with a named OpenRouter slug such as `stealth/ox-alpha`           |
