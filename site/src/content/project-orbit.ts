...
export const ORBIT_PROJECTS = [
  ...
  },
  {
    id: "kurva",
    name: "KURVA",
    description: "A local design canvas from picture to layered SVG and Blender.",
    category: "Design",
    destination: "internal-route",
    href: "/work/kurva",
    external: false,
  ...
  },
  {
    id: "pistola",
    name: "PISTOLA",
    description: "Say the object, get an editable 3D scene and CAD geometry.",
    category: "Design",
    destination: "internal-route",
    href: "/work/pistola",
    external: false,
...
export const ATOMIC_ORBIT_RINGS: readonly AtomicRingDefinition[] = [
  ...
  },
  {
    ...
    bearingBalls: 16,
    projectIds: ["ifoundyou", "sound-lab", "kurva"],
    initialNodeAngles: [(-30 * Math.PI) / 180, (-145 * Math.PI) / 180, (-95 * Math.PI) / 180],
  },
  {
    id: "diagonal-b",
    ...
    rotationEuler: [0.08, -0.11, -DIAGONAL_TILT],
    bearingBalls: 16,
    projectIds: ["strudelai", "astraea", "pinaculo", "pistola"],
    initialNodeAngles: [
      (-150 * Math.PI) / 180,
      (-35 * Math.PI) / 180,
      (28 * Math.PI) / 180,
