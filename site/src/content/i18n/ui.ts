...
const EN = {
  ...
  laboratory: {
    ...
    lead: "A working index for future energy, electronics / AI, aerial systems, and software lineage in the Laboratory.",
    ...
    benchCaption: "Three concept mechanisms and one paper · no live data or flight claim",
    registerLabel: "Current register / 01",
    registerHeading: "Four threads, each with a visible limit.",
    registerBody:
      "Future Energy keeps a held case-study route and CodeAncestry has its written concept paper; Electronics / AI and Aerial systems remain in-scene Laboratory threads without separate product claims.",
  ...
  sound: {
    ...
    systemLabel: (folio: string) => `System / ${folio}`,
    ...
    rightsLabel: "Rights",
    playerLabel: (title: string) => `${title} — audio player`,
  ...
  story: {
    ...
    portraitCaption: "Emblem in place of a portrait",
    emblemLabel: "The CA²M emblem, turning slowly.",
    opportunityLabel: "Opportunity / 02",
    opportunityHeading: "Chemistry I could not read.",
    opportunityBody:
      "In July 2025 two researchers in the chemistry department of my own university published an open-access paper on vanadium redox flow batteries. I have no background in electrochemistry and could not follow most of it.",
    opportunityTurn:
      "It is a chemistry paper and it does chemistry. What it does not do, because that is not its job, is ask who would want the result. That gap is the part I find interesting \u2014 and whether someone without the background can still see across it.",
    foundLabel: "Found / open access",
    foundNotMine: "Not my work",
    foundInstitution: "Authors\u2019 department",
    foundLicence: "Licence",
    foundRead: "Read the paper",
    builtLabel: "Built / prototype",
    builtHeading: "So I built the cell.",
    builtBody:
      "A working redox flow battery prototype, made to find out whether I could. It proves nothing about the paper and measures nothing against it. It is the point at which the question stopped being chemistry and started being commercial: who needs this, and would they pay for it?",
    builtAction: "Watch the prototype run",
    builtMeta: "Video \u00b7 external site",
    perspectiveLabel: "Perspective / 01",
    perspectiveHeading: "The person behind the systems.",
    practiceLabel: "Practice / 03",
    practiceHeading: "Three threads, one evolving practice.",
    practiceAria: "Approved practice threads",
    recordLabel: "Public record / 04",
...
const ES: UiCopy = {
  ...
  laboratory: {
    ...
    lead: "Un índice de trabajo para la energía del futuro, la electrónica y la IA, los sistemas aéreos y el linaje del software en el Laboratorio.",
    ...
    benchCaption:
      "Tres mecanismos conceptuales y un artículo · sin datos en vivo ni afirmaciones de vuelo",
    registerLabel: "Registro actual / 01",
    registerHeading: "Cuatro hilos, cada uno con un límite visible.",
    registerBody:
      "Future Energy conserva una ruta de caso de estudio en espera y CodeAncestry tiene su artículo conceptual escrito; Electrónica / IA y Sistemas aéreos siguen siendo hilos del Laboratorio dentro de la escena, sin afirmaciones de producto aparte.",
  ...
  sound: {
    ...
    systemLabel: (folio: string) => `Sistema / ${folio}`,
    strudelPathsAria: "Rutas públicas de StrudelAI",
    musicLabel: "Música / 02",
    musicHeading: "Pistas.",
    ...
    playerLabel: (title: string) => `${title} — reproductor de audio`,
  ...
  story: {
    ...
    portraitCaption: "Emblema en lugar de un retrato",
    emblemLabel: "El emblema CA²M, girando despacio.",
    opportunityLabel: "Oportunidad / 02",
    opportunityHeading: "Qu\u00edmica que no s\u00e9 leer.",
    opportunityBody:
      "En julio de 2025, dos investigadores del departamento de qu\u00edmica de mi propia universidad publicaron un art\u00edculo de acceso abierto sobre bater\u00edas de flujo redox de vanadio. No tengo formaci\u00f3n en electroqu\u00edmica y no pude seguir la mayor parte.",
    opportunityTurn:
      "Es un art\u00edculo de qu\u00edmica y hace qu\u00edmica. Lo que no hace, porque no es su trabajo, es preguntar qui\u00e9n querr\u00eda el resultado. Ese hueco es la parte que me interesa, y si alguien sin la formaci\u00f3n puede verlo igualmente.",
    foundLabel: "Encontrado / acceso abierto",
    foundNotMine: "No es mi trabajo",
    foundInstitution: "Departamento de los autores",
    foundLicence: "Licencia",
    foundRead: "Leer el art\u00edculo",
    builtLabel: "Construido / prototipo",
    builtHeading: "As\u00ed que constru\u00ed la celda.",
    builtBody:
      "Un prototipo funcional de bater\u00eda de flujo redox, hecho para averiguar si pod\u00eda. No demuestra nada sobre el art\u00edculo ni mide nada frente a \u00e9l. Es el punto en el que la pregunta dej\u00f3 de ser qu\u00edmica y pas\u00f3 a ser comercial: qui\u00e9n necesita esto y estar\u00eda dispuesto a pagar por ello.",
    builtAction: "Ver el prototipo en marcha",
    builtMeta: "V\u00eddeo \u00b7 sitio externo",
    perspectiveLabel: "Perspectiva / 01",
    perspectiveHeading: "La persona detrás de los sistemas.",
    practiceLabel: "Práctica / 03",
    practiceHeading: "Tres hilos, una práctica que evoluciona.",
    practiceAria: "Hilos de práctica aprobados",
    recordLabel: "Registro público / 04",
