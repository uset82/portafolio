...
export const KEYLIT_ES = {
  status: "Abierto para probar",
  summary:
    "Tutor de piano con IA gratuito que te escucha directamente en la página. Ilumina la siguiente tecla, la tocas y luego ilumina la siguiente. Creado para el OpenAI WebMCP Challenge.",
