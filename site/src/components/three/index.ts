...
export { ObservatoryQualityControl } from "./observatory-quality-control";
...
export type { ObservatoryQualityControlProps } from "./observatory-quality-control";
