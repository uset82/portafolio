...
export const observatoryAssetRegistry = {
  ...
  assets: [
    ...
    },
    {
      ...
      clips: [
        { id: "idle", source: "procedural", required: true },
        { id: "head-acknowledgement", source: "procedural", required: true },
        { id: "finger-water-contact", source: "procedural", required: true },
      ],
      ...
      provenance: authoredRuntimeProvenance(
        "Runtime-authored kneeling ceramic guide built entirely in repository code from the approved reference pack; stylized approximation only, approved as the U.17 rights-safe fallback",
      ),
      loadingPriority: "hero-critical",
    },
    {
    ...
    },
    {
      ...
      nodes: [
        ...
        "FutureEnergyVessels",
        "FutureEnergyPumps",
        "FutureEnergySageReservoir",
        "FutureEnergyTeaReservoir",
        "FutureEnergySagePump",
        "FutureEnergyTeaPump",
        "FutureEnergyCellStack",
        "FutureEnergyStackLeftPort",
        "FutureEnergyStackRightPort",
