...
Desktop at 1672?941 uses reference-normalized anchors: robot target `(0.66, 0.47)`, hand/water contact `(0.58, 0.65)`, drone `(0.72, 0.18)`, ASTRAEA `(0.91, 0.40)`, PIN?CULO `(0.57, 0.82)`, Sound Lab `(0.26, 0.79)`, energy `(0.48, 0.31)`, electronics `(0.35, 0.50)`, CC AI `(0.88, 0.68)`. The headline safe zone is x `0.025?0.31`, y `0.20?0.52`. Mobile prioritizes robot face, hand, water, and one labeled artifact; foreground artifacts may move below the fold as DOM entries.
...
| PIN?CULO | low foreground view | Artifact button/mesh select | 700ms | Same |
...
| PIN?CULO | Number ring highlight, optional mechanical tick | ?PIN?CULO ? Numerological engine?; Cosmos/case study | Foreground does not block robot hand contact point |
...
- ASTRAEA/PIN?CULO: movement only on selection or very slow idle tick; no perpetual spinning.
