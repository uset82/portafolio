<!-- generatedBy: brain:sync-github; source: https://github.com/uset82/portafolio/blob/main/docs/content/flagship-selection.md; checkedOn: 2026-07-31; redactions: 0 -->
...
- The order starts with a public-facing experience, moves through creative and human-centred products, then reveals the systems and tooling underneath.
- All five projects cover materially different problems; none is included only to increase project count.
- The selection deliberately postpones performance numbers, ownership claims, sensitive data, screenshots, and production-status language until the dedicated audits.
- If a project fails its evidence, rights, privacy, or availability gate, it is removed rather than replaced with invented material.

## Source check

On 2026-07-19, the five repositories were present under the confirmed GitHub account:

- `https://github.com/uset82/StrudelAI`
- `https://github.com/uset82/avatar-studio`
- `https://github.com/uset82/iFoundYou`
- `https://github.com/uset82/opennemoclaw`
